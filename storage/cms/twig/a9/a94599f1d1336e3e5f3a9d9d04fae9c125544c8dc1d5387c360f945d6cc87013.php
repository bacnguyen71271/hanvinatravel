...
/* /home/tiepjimmy/web/hanvinatravel.vn/public_html/plugins/indikator/news/components/tours/default.htm */
class __TwigTemplate_0381fc2bb667c6bfde81b428c96fb5dfa626f9813a37c31065a790098063dd10 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<section class=\"destinations destination-padding\">
    <div class=\"container\">
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, ($context["__SELF__"] ?? null), "places", [], "any", false, false, false, 11));
        foreach ($context['_seq'] as $context["_key"] => $context["place"]) {
            ...
            echo "                            <li class=\"filter-item filter-item--check-box\">
                                <label class=\"checkbox_item theme_blue\">
                                    <span>";
            // line 14
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["place"], "name", [], "any", false, false, false, 14), "html", null, true);
            echo "</span>
                                    <input type=\"checkbox\" class=\"ck-places\" name=\"places[";
            // line 15
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["place"], "id", [], "any", false, false, false, 15), "html", null, true);
            echo "]\" value=\"";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["place"], "id", [], "any", false, false, false, 15), "html", null, true);
            echo "\">
        ...
        <div class=\"row mix asia\" style=\"position: relative;\">     
           
            <div class=\"col-md-12\" id=\"tour-area\">
                ";
        // line 26
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, ($context["__SELF__"] ?? null), "posts", [], "any", false, false, false, 26));
...
";
    ...
    {
        return "/home/tiepjimmy/web/hanvinatravel.vn/public_html/plugins/indikator/news/components/tours/default.htm";
    }
    ...
    {
        return array (  171 => 63,  165 => 59,  156 => 54,  141 => 52,  137 => 51,  133 => 50,  128 => 47,  125 => 46,  113 => 40,  107 => 37,  102 => 35,  98 => 34,  91 => 30,  86 => 27,  82 => 26,  74 => 20,  61 => 15,  57 => 14,  53 => 12,  49 => 11,  37 => 1,);
    }
...
{% partial __SELF__ ~ '::script' %}", "/home/tiepjimmy/web/hanvinatravel.vn/public_html/plugins/indikator/news/components/tours/default.htm", "");
    }
}
