...
class Plugin extends PluginBase
{
        ...
        return [
            'news' => [
                ...
                'sideMenu' => [
                    ...
                    'tour' => [
                        'label'       => 'Tour',
                        'url'         => Backend::url('indikator/news/posts?category=tour'),
                        'icon'        => 'icon-file-text',
                        'permissions' => ['indikator.news.posts'],
                        'order'       => 101
                    ],
                    'combotour' => [
                        'label'       => 'Combo Tour',
                        'url'         => Backend::url('indikator/news/posts?category=combotour'),
                        'icon'        => 'icon-file-text',
                        'permissions' => ['indikator.news.posts'],
                        'order'       => 101
                    ],
    ...
    public function registerComponents()
    {
        return [
            ...
            'Indikator\News\Components\Postss'        => 'newsPost',
            ...
            'Indikator\News\Components\Tintuc' => 'news',
            'Indikator\News\Components\Customer' => 'customer',
            'Indikator\News\Components\Postcustomer' => 'postcustomer',
            'Indikator\News\Components\Tour' => 'tour',
            'Indikator\News\Components\Tours' => 'tours',
            'Indikator\News\Components\Tours2' => 'tours2',
            'Indikator\News\Components\HomePageComboTours' => 'homePageComboTours',
            'Indikator\News\Components\HomePageTours' => 'homePageTours',
        ];
    }
